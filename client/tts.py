# -*- coding: utf-8-*-
"""
A Speaker handles audio output from jarvis to the user
...
class AbstractTTSEngine(object):
    ...
    def play(self, filename):
        ...
        # See issue jarvisproject/jarvis-client#188
...
class EspeakTTS(AbstractTTSEngine):
    """
    Uses the eSpeak speech synthesizer included in the jarvis disk image
    ...
    def get_config(cls):
        ...
        profile_path = jarvispath.config('profile.yml')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='jarvis TTS module')
